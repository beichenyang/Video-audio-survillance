# UDPBigcam_server V0.0.1: Get data from clould, decode 
...
def UDP_Server_Audio(timeFlag,videoRecStartTime,child_CamActMsgConn):
  ...
  server_address = ('169.234.42.229', 10000)
...
def Camera(REC_start,REC_duration,REC_start_time_in,REC_start_time_out,child_CamDurMsgConn):
    ...
    if REC_start.value == 1:
      ...
      while(cap.isOpened()):
        ...
        if ret==True:
          ...
          if curr_time - ini_time > recording_duration: 
...
if __name__ == '__main__':
  ...
  p4 = Process(target=Camera, args=(REC_start,REC_duration,REC_start_time_in,REC_start_time_out,child_CamDurMsgConn))
